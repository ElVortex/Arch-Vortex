...
mkdir $HOME/Arch-Vortex/arch-theming
tar -xzvf $HOME/Arch-Vortex/arch-theming.tar.gz -C $HOME/Arch-Vortex/arch-theming
cp -rv $HOME/Arch-Vortex/arch-theming/.icons /home/$USERNAME/
cp -rv $HOME/Arch-Vortex/arch-theming/.themes /home/$USERNAME/
chmod -R a=xrw /home/$USERNAME/.icons
chmod -R a=xrw /home/$USERNAME/.themes
ls

tar -xzvf $HOME/Arch-Vortex/arch-config.tar.gz -C $HOME/Arch-Vortex/
cp -rv $HOME/Arch-Vortex/.config /home/$USERNAME/
...
-------------------------------------------------------------------------
"
#tar -xzvf $HOME/Arch-Vortex/awesome.tar.gz -C $HOME/Arch-Vortex/
#cp -rv $HOME/Arch-Vortex/awesome /home/$USERNAME/.config/
...
rm -r $HOME/Arch-Vortex
rm -r /home/$USERNAME/Arch-Vortex
